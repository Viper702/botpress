...
4. Continue running commands in the **botpress terminal window**
    ```shell
    # Install the dependencies
    bar/botpress/packages/core/botpress $ npm install
    # Compile and run the botpress server
